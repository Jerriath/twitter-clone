    ...
    return (
        <div className="leftPanel" >
            <Link className="logo" to="/">
                <img onClick={props.onHomeHandler} className="logoImg" src={Logo} alt="Page logo" />
            </Link>
            <div className="leftOption selected" >
                ...
                <h2 onClick={props.onHomeHandler} className="optionFont">Home</h2>
            </div>
            <div className="leftOption" >
                ...
                <h2 onClick={props.onProfileHandler} className="optionFont">Profile</h2>
            </div>
